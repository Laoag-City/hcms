if(to_pink_card_print_ids.length == 0)
...
function removeRow(id)
{
	...
	let index = to_pink_card_print_ids.indexOf(id);
	to_pink_card_print_ids.splice(index, 1);
...
$('.ui.search').search({
	...
	onSelect: function(result, response){
		if(!to_pink_card_print_ids.includes(result.id))
		{
			to_pink_card_print_ids.push(result.id);
