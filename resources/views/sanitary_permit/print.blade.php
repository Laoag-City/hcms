		...
		<div id="contents">
			...
			<div id="body">
				...
				<div class="auto_flow">
					...
					<b style="display: block; float: right; width: 380pt; font-family: serif;" class="text-center">RODRIGO L. CATCATAN JR. M.D.</b>
					<b style="display: block; float: right; width: 380pt; font-family: serif; font-size: 10.5pt;" class="text-center">OFFICER-IN-CHARGE</b>
				</div>
			</div>
